...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Toutes les Reservations</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <form class="" method="post" action="ajoutReservationA.php" enctype="multipart/form-data">
         <div class="col-md-6">
...
<!--<?PHP
      ...
      include "../core/reservationC.php";
            if (isset($_GET['numReservation'])){
                ...
                $reservation=$reservationC->recupererReservation($_GET['numReservation']);
...
<label for="cc-name" class="control-label mb-1">Numero Reservation</label>
<input id="cc-name"  value="<?PHP echo $numReservation ?>" name="numReservation" type="text" class="form-control cc-name valid" data-val="true" data-val-required="veuillez entre le numero de la reservation" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
...
if (isset($_POST['modifierReservationA'])){
    ...
    header('Location: afficherReservationA.php');
    }
?> -->
...
<div class="card">
<div class="card-header">
<strong class="card-title">Les reservations</strong>
</div>
<div class="card-body">
...
<!--<form method="POST" action="modifierReservationA.php">
<input type="submit" class="btn social pinterest"  name="modifier" value="Modifier">-->
