                            ...
                            <div class="card-body">
                                <!-- Credit Card -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  class="form-control" type="text" id="nom_service" name="nom_service" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
