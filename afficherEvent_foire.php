        ...
        <div class="gallery-description text-center">
          ...
          <table class="table table-borderless">
            <tr>
              ...
              <th scope="col">Nombre max de participants</th>
            ...
            ?>
              ...
              <tr>
                ...
                <td >
                        ...
                        <?PHP echo $row['localisation']; ?> </div>
                    
                </td>
                <td >
                  
                        <?PHP echo $row['nbmax']; ?> </div>
                    
                </td>
                <td >
                  
                        <?PHP echo $row['libelle']; ?> </div>
                    
                </td>
                <td >
                  
                        <?PHP echo $row['date_d']; ?> </div>
                    
                </td>
                <td >
                  
                        <?PHP echo $row['date_f']; ?> </div>
          ...
          <td >
                ...
                <td>
                  ...
                  <div class="contact-btn text-center">
                    <input type="submit" name="supprimer" value="supprimer" class="btn btn-default btn-main">
                ...
                <td>
                  ...
                  <div class="contact-btn text-center">
                    <input type="submit" name="modifier" value="modifier" class="btn btn-default btn-main">
                    <input type="hidden" value=<?PHP echo $row['IDtype']; ?> name="IDtype">
                  </div>
                  </form>
                </td>
                <td>
                  ...
                  <div class="contact-btn text-center">
                    <input type="submit" name="participer" value="participer" class="btn btn-default btn-main">
                    <input type="hidden" value=<?PHP echo $row['IDtype']; ?> name="IDtype">
                  </div>
                  </form>
                </td>
