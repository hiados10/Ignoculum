      ...
      <div class="row margin-0">
        ...
        <div class="flex">
          <div class="col-md-12 col-lg-6  padding-0">
            <img src="images/portfolio/meeting1.jpg" alt="">
          </div>
          <div class="col-md-12 col-lg-6 portfolio-single-description padding-0">
            <div class="portfolio-single-info">
              <p class="date"> N’attendez plus qu’une occasion spéciale se présente pour rencontrer votre vendeur de service : au contraire, planifiez vos meeting dans le cadre de votre stratégie, et provoquez les occasions !</p>
              <h3 class="portfolio-single-title"> TROUVER Le meeting QUI VOUS CORRESPOND, C’EST FACILE</h3>
              <div class="row margin-0">
      ...
      <div class="row">
        ...
        <table>
          ...
          if (@$_POST['recherche'] == null)
            $listeEvent = $evenement->afficherEvents_meeting();
          else
            $listeEvent = $evenement->rechercher_evenement($_POST['recherche']);

            if(isset($_POST['triera']))
            {
              $listeEvent=$evenement->triera_meeting();
            }
            if(isset($_POST['trierp']))
            {
              $listeEvent=$evenement->trierp_meeting();
            }
