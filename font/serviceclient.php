  ...
  <div class="title text-center">
      ...
      <div class="col-md-6">
          <div class="form-group">
            <input type="text" class="w" placeholder="E-mail" id="mail" name="mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" oninvalid="setCustomValidity('Veuillez entrer une adresse valide')" oninput="setCustomValidity('')">
          </div>
